...
# 发件人邮箱
mail_sender = "1299088269@qq.com"
# 邮箱授权码
mail_license = "ovdavasgzvvehhch"
# 收件人邮箱，可以为多个收件人
mail_receivers = ["1427177855@qq.com", "16422802@qq.com"]
# 构建MIMEMultipart对象代表邮件本身，可以往里面添加文本，图片，附件等
mm = MIMEMultipart('related')
# 邮件主题
subject_content = """python邮件测试"""
# 设置发送者，注意格式，里面有邮箱为发件人邮箱
mm['From'] = "田震<1299088269@qq.com>"
# 设置接受者，注意格式，里面邮箱为接受者邮箱，可以设置多个
mm['To'] = "陶永新<1427177855@qq.com>,陶然然<16422802@qq.com>"
# 设置邮件主题
mm['Subject'] = Header(subject_content, 'utf-8')
# 邮件正文内容
body_content = """hello,这是Python发出的邮件————田震"""
